...
<ul>
<li>Create an account on Slack and create your own workspace.</li>
<li>Clone this repo, pip install the requirements and create auth.py:</li>
</ul>

<div class="highlight highlight-source-shell"><pre>git clone https://github.com/VirtualGoat/Twitter-Profile-Analyzer.git
<span class="pl-c1">cd</span> Go-Karuna-Go
